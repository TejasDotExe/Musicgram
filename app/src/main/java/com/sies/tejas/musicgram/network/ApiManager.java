package com.sies.tejas.musicgram.network;
...
import com.sies.tejas.musicgram.network.utility.RequestNetworkController;
...
public class ApiManager {
    ...
    public void getSongSuggestions(@NonNull String songId,Integer limit, @NonNull RequestNetwork.RequestListener listener) {
        String url = SEARCH_URL + "/songs/" + songId + "/suggestions";
        HashMap<String, Object> queryMap = new HashMap<>();
        queryMap.put("limit", limit);
        requestNetwork.setParams(queryMap, RequestNetworkController.REQUEST_PARAM);
        requestNetwork.startRequestNetwork(RequestNetworkController.GET, url, "", listener);
    }
